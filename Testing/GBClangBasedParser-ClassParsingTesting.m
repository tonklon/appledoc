//
//  GBClangBasedParser-ClassParsingTesting.m
//  appledoc
//
...
@interface GBClangBasedParserClassParsingTesting : GBObjectsAssertor
@end

@implementation GBClangBasedParserClassParsingTesting
